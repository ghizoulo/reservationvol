											...
											<form method="POST" action="aeroport/add.htm">
												<div class="form-group">
													<label for="recipient-name" class="control-label">Nom
														aeroport:</label> <input type="text" class="form-control"
														name="nom">
												</div>
												<div class="form-group">
													<label for="message-text" class="control-label">Ville
														Aeroport:</label> <input type="text" class="form-control"
														name="ville">
												</div>
										...
										<tbody>
											<v:forEach items="${listeAeroport}" var="o">
												<tr>
													<td>${o.nom}</td>
													<td>${o.ville}</td>
													<td><a href="aeroport/delete.htm?id=${o.id}">supprimer</a>
														<button type="button" class="btn btn-primary"
															data-toggle="modal" data-target="#${o.id}"
															data-whatever="@getbootstrap">Modifier</button>
														<div class="modal fade" id="${o.id}" tabindex="-1"
															role="dialog" aria-labelledby="exampleModalLabel">
															<div class="modal-dialog" role="document">
																<div class="modal-content">
																	<div class="modal-header">
																	...
																	<div class="modal-body">
																		<form method="POST"
																			action="aeroport/update.htm?id=${o.id}">
																			<div class="form-group">
																				<label for="recipient-name" class="control-label">Nom
																					aeroport:</label> <input type="text" class="form-control"
																					id="exampleInputEmail1" name="type"
																					value="${o.nom}">
