                                 ...
                                 <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                                     <div class="modal-header">
                                                      ...
                                                      <h4 class="modal-title" id="exampleModalLabel">Ajouter un Vol</h4>
                                                      </div>
                                                      ...
                                                      <div class="box box-info">
                                                       ...
                                                       <div class="box-body">
                                                        <div class="box-body">
                                                             <div class="form-group">
                                                                  <label>
                                                                  <input type="checkbox" class="flat-red" name="Économique" value="Économique" checked>Économique
                                                                  </label> </br>
                                                             ...
                                                             <div class="form-group">
                                                                  <label>
                                                                  <input type="checkbox" class="flat-red" name="Premium economy" value="Premium economy">Premium economy
                                                                  </label></br>
                                                            ...
                                                            <div class="form-group">
                                                                    <label>
                                                                    <input type="checkbox" class="flat-red" name="Affaires" value="Affaires">Affaires
                                                                    </label></br>
                                                            ...
                                                            <div class="form-group">
                                                                    <label>
                                                                    <input type="checkbox" class="flat-red" name="Première" value="Première">Première
                                                                    </label></br>
